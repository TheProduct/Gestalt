...
public class JoglTexCreatorFBO_2xRGBA32Float
    ...
    public void create(final GL gl,
        ...
        /* create buffers */
        boolean myResult = createBuffers(gl, theBufferID);
        if (!myResult) {
            System.out.println("### WARNING / buffer not properly created.");
        }
        ...
        createTexture(gl,
                      theWidth, theHeight,
                      theBufferID.additional_textures[BufferInfo.SECONDARY],
                      theBufferID.additional_attachment_points[BufferInfo.SECONDARY]);
    }
    ...
    private boolean createBuffers(GL gl, BufferInfo theBufferIDs) {
        ...
        /* create textures */
        int[] myTextureConainter = new int[2];
        gl.glGenTextures(2, myTextureConainter, 0);
        theBufferIDs.texture = myTextureConainter[0];
        theBufferIDs.additional_textures[BufferInfo.SECONDARY] = myTextureConainter[1];
